...
# Add luci-theme-infinityfreedom-ng
svn co https://github.com/xiaoqingfengATGH/luci-theme-infinityfreedom/trunk/luci-theme-infinityfreedom-ng ./package/lean/luci-theme-infinityfreedom-ng
default_theme='infinityfreedom-ng'
